<template>
  <div
    v-theme="theme"
    class="mk-AppProgress"
    :data-direction="props.direction"
  >
    <div
      v-if="label || $slots.label"
      class="mk-AppProgress-label"
      :style="labelStyle"
    >
      <slot
        name="label"
    ...
    <ProgressRoot
      ...
      class="mk-AppProgress-root"
      :max="max"
    >
      <ProgressIndicator
        class="mk-AppProgress-indicator"
        :style="indicatorStyle"
      />
    </ProgressRoot>

    <div v-if="steps" class="mk-AppProgress-steps">
...
export type Emits = ProgressRootEmits & {
