...
import AppToast from '../AppToast/AppToast.vue';
...
const collectionGapSize = useCssVar('--mk-toast-context-collection-gap-size', rootRef);
const toastAnimationDuration = useCssVar('--mk-toast-context-toast-animation-duration', rootRef);
...
.mk-TheToastContext {
  --mk-toast-context-width-size: calc(var(--mk-size-1) * 100);
  --mk-toast-context-offset-x-size: var(--mk-size-2);
  --mk-toast-context-offset-y-size: var(--mk-size-2);
  --mk-toast-context-collection-gap-size: var(--mk-size-2);
  --mk-toast-context-toast-animation-duration: var(--mk-transition-transform-duration);
  --mk-toast-context-toast-animation-from-offset-size: 100%;
  --mk-toast-context-toast-animation-to-offset-size: 100%;
  --mk-toast-context-toast-animation-from-opacity: 0;
  --mk-toast-context-toast-animation-to-opacity: 0;

  $this: &;

  position: fixed;
  z-index: var(--mk-floating-layer-z-index);
  width: var(--mk-toast-context-width-size);
  max-width: calc(100% - var(--mk-toast-context-offset-x-size) * 2);
  height: calc(var(--virtual-height) * 1px);
  padding: 0;
  margin: 0;
  transition: height var(--mk-toast-context-toast-animation-duration);
  will-change: height;

  &[data-position^='top'] {
    top: var(--mk-toast-context-offset-y-size);
  ...
  &[data-position^='bottom'] {
    bottom: var(--mk-toast-context-offset-y-size);
  ...
  &[data-position$='left'] {
    left: var(--mk-toast-context-offset-x-size);
  }
  ...
  &[data-position$='right'] {
    right: var(--mk-toast-context-offset-x-size);
  }

  &-toast {
    position: absolute;
    width: 100%;
    transition: transform var(--mk-toast-context-toast-animation-duration);
    ...
    &[data-state='open'] {
      &[data-position^='top'] {
        animation: slide-from-up var(--mk-toast-context-toast-animation-duration);
      }

      &[data-position^='bottom'],
      &[data-position^='center'] {
        animation: slide-from-down var(--mk-toast-context-toast-animation-duration);
      }

      @keyframes slide-from-up {
        from {
          opacity: var(--mk-toast-context-toast-animation-from-opacity);
          transform: translate(
            var(--translate-x),
            calc(var(--translate-y) - var(--mk-toast-context-toast-animation-from-offset-size))
          );
        }
    ...
    &[data-state='closed'] {
      &[data-position^='top'] {
        animation: slide-to-up var(--mk-toast-context-toast-animation-duration);
      }

      &[data-position^='bottom'],
      &[data-position^='center'] {
        animation: slide-to-down var(--mk-toast-context-toast-animation-duration);
      }
      ...
      @keyframes slide-to-up {
        ...
        to {
          opacity: var(--mk-toast-context-toast-animation-to-opacity);
          transform: translate(
            var(--translate-x),
            calc(var(--offset-y) - var(--mk-toast-context-toast-animation-to-offset-size))
          );
        }
      }
    ...
    &[data-swipe='end'] {
      &[data-swipe-direction='up'] {
        animation: swipe-to-up var(--mk-toast-context-toast-animation-duration);
      }

      &[data-swipe-direction='right'] {
        animation: swipe-to-right var(--mk-toast-context-toast-animation-duration);
      }

      &[data-swipe-direction='down'] {
        animation: swipe-to-down var(--mk-toast-context-toast-animation-duration);
      }

      &[data-swipe-direction='left'] {
        animation: swipe-to-left var(--mk-toast-context-toast-animation-duration);
      }
      ...
      @keyframes swipe-to-right {
        ...
        to {
          opacity: var(--mk-toast-context-toast-animation-to-opacity);
          transform: translate(var(--mk-toast-context-toast-animation-to-offset-size), var(--translate-y));
        }
      }
      ...
      @keyframes swipe-to-left {
        ...
        to {
          opacity: var(--mk-toast-context-toast-animation-to-opacity);
          transform: translate(calc(var(--mk-toast-context-toast-animation-to-offset-size) * -1), var(--translate-y));
        }
      }
    }
  }
