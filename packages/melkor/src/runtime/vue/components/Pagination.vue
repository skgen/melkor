<template>
  ...
  >
    <button
      class="mk-Pagination-slot mk-Pagination-cta"
    ...
    <div class="mk-Pagination-list">
      <button
        class="mk-Pagination-slot mk-Pagination-page"
...
export type PaginationEmits = {
  'update:model-value': [value: PaginationProps['modelValue']];
};
</script>
