...
import { createGlobalConfig, globalConfigContextKey, type MelkorOptions } from './features';
...
export function createMelkor(options?: DeepObjectPartial<MelkorOptions>): Plugin<[]> {
